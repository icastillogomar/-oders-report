...
/**
 * Tarjetas de resumen (KPI) para el módulo Firebase Search.
 */
export default function SearchSummary({ summary }) {
  ...
  // Cálculos de porcentajes para dar mayor insight analítico
    ...
    <div style={{ marginBottom: '24px' }}>
      ...
      <div className="kpis-grid" style={{
        ...
        <div className="kpi-card" style={{
          ...
          <div>
            ...
            <span className="trend trend--neutral" style={{ display: 'block', fontSize: '11px', marginTop: '2px' }}>
              {uniqueOrdersCount} únicas en Excel
            </span>
          </div>
        </div>
        ...
        <div className="kpi-card" style={{
          ...
          <div>
            <span className="subtitle" style={{ fontSize: '12px', display: 'block' }}>Encontradas</span>
